...
export default class DialogueManager {
    maxStepCount;
    ClientManager_DungeonMaster;
    ClientManager_N2N_Source;
    ClientManager_N2N_Target;
    stepCount = 0;
    shouldStop = false;
    sourceHistory = [];
    targetHistory = [];
    ...
    constructor(maxStepCount, ClientManager_DungeonMaster, ClientManager_N2N_Source, ClientManager_N2N_Target) {
        ...
        this.ClientManager_N2N_Source = ClientManager_N2N_Source;
        this.ClientManager_N2N_Target = ClientManager_N2N_Target;
    }
